...
while i < num do
  ...
  Trainer.create("account_name" => acct_tmp, "email" => email_tmp,
    ...
    'middle_name' => acct_tmp, "image_uri" => "https://i.imgur.com/HHDHoBn.png",
    'address1' => add_tmp, 'city' => 'West Covina',
    'zip' => 99999)
  i+= 1
end

# while loop user creation for mass users creation
i= 0
num=10
while i < num do
  acct_tmp = 'jo' + i.to_s
